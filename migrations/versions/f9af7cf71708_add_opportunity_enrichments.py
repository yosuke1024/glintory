...
down_revision: str | Sequence[str] | None = "b68c7eff7f71"
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_opportunity_enrichments_opp_id",
        "opportunity_enrichments",
        ["opportunity_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "idx_opportunity_enrichments_opp_id", table_name="opportunity_enrichments"
    )
